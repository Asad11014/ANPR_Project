...
from visualise import process_video_with_license_plate
import cv2
...
class VideoProcessingApp:
    def __init__(self, master):
        ...
        # Label and entry for authorised number plates
        self.label = tk.Label(self.top_frame, text="Enter authorised number plates (separated by commas):")
    ...
    def process_video(self):
        ...
        try:
            process_video_with_license_plate('./assets/demo.mp4', './assets/results/test_interpolated.csv', './assets/results/out.mp4', authorised_plates=number_plates)
